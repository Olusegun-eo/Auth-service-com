...
public class ExcelHelper {
    ...
    public static List<String> USER_BONUS_HEADERS = Arrays.asList("AMOUNT", "OFFICE_DEBIT_ACCOUNT", "CUSTOMER_CREDIT_NUMBER", "TRAN_TYPE", "TRAN_C_RNCY", "TRAN_NARRATION", "USER_ID" );
