...
public class UtilController {
    ...
    public ApiResponse<OTPBase> getOTPTokenByEmail(@PathVariable  @Email String email,
        ...
        return new ApiResponse<>(dbObject, "Success", true);
    }
    ...
    public ApiResponse<OTPBase> getOTPTokenByPhone(@PathVariable  @Email String phoneNumber,
                                            @PathVariable @EnumValue(enumClass = OTPRequestType.class, message = "Must be of type {enumClass}")
                                                    String requestType){
