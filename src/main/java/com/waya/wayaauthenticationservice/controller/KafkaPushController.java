...
public class KafkaPushController {
    ...
    public ResponseEntity<?> createProfilePush(@RequestBody PersonalProfileRequest profilePojo) {
    ...
    public ResponseEntity<?> createCorporateProfilePush(@RequestBody CorporateProfileRequest profilePojo) {
