...
@Tag(name = "FRAUD ACTIONS", description = "Fraud Action Services for Authentication Service API")
@AllArgsConstructor
@Validated
public class FraudActionsController {
    ...
    @ApiOperation(value = "Get User Details User by ID (In-app use only)", tags = {"FRAUD ACTIONS"})
    ...
    @ApiOperation(value = "Toggle Lock on User's Account by ID (In-app use only)", tags = {"FRAUD ACTIONS"})
    ...
    @ApiOperation(value = "Toggle Activation on User's Account by ID (In-app use only)", tags = {"FRAUD ACTIONS"})
    ...
    @ApiOperation(value = "Close User's Account by ID (In-app use only)", tags = {"FRAUD ACTIONS"})
