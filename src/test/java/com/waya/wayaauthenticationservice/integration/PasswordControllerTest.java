...
public class PasswordControllerTest {
    ...
    public void resetPasswordFailed() throws Exception {
        ...
        resetPassword(pojo, "$.message", ErrorMessages.NO_RECORD_FOUND.getErrorMessage()
                + " For User with email/phoneNumber: noemail@waya.com", status().isBadRequest());
    }
    ...
    private void changePassword(PasswordPojo pojo, String jsonPath0, String jsonPathMessage0, ResultMatcher expectedStatus) throws Exception {
        mockMvc.perform(post("/api/v1/password/change-password")
    ...
    private void resetPassword(ResetPasswordPojo pojo, String jsonPath0, String jsonPathMessage0, ResultMatcher expectedStatus) throws Exception {
